...
const customDataSource = new CustomStore({
  ...
  load: () => {
      return $.getJSON('http://103.57.222.116/index.php/api/getquangcao');
  },
  ...
  <div className="row">
    ...
    <div className="col-sm-12">
      ...
      >
        ...
        {localStorage.getItem('userrole')==="1" ?   <Editing mode="popup" allowUpdating={true} allowDeleting={true} allowAdding={true} ></Editing>   : ''}
        {localStorage.getItem('userrole')==="6" ?   <Editing mode="popup" allowUpdating={true} allowDeleting={true} allowAdding={true} ></Editing>   : ''}
