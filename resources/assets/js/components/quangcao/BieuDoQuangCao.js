      ...
      <table className="table-bordered table-hover table tabletextsmall color-table primary-table xetkpi">
                                ...
                                {kpi.map((cd, index) => (
                                    <tr key={cd.id} className="maukpi">
                                        <td>
                                        {localStorage.getItem('userrole')==="6" ?   <button className="icon-smallx icon-list-demo btn btn-info btn-circle btn-xl" data-idkpi={cd.id} data-toggle="modal" data-target="#exampleModalKPICapNhat" data-whatever="@mdo"><i className="fa fa-pencil" data-idkpi={cd.id}></i></button>   : ''}
                                        {localStorage.getItem('userrole')==="1" ?   <button className="icon-smallx icon-list-demo btn btn-info btn-circle btn-xl" data-idkpi={cd.id} data-toggle="modal" data-target="#exampleModalKPICapNhat" data-whatever="@mdo"><i className="fa fa-pencil" data-idkpi={cd.id}></i></button>   : ''}
                                          </td>
                                        <td>KPI
