        ...
        <table className="table-bordered table-hover table color-table primary-table" >
          ...
          {danhsachloaiquangcao.map(dv => ( 
            <tr id={"loaiquangcaoitem"+dv.id} data-itemdv={dv.id}>
              ...
              {localStorage.getItem('userrole')==="1" ? <button data-idloaiquangcao={dv.id} onClick={this.handleDeleteLoaiQuangCao} className="icon-list-demo btn btn-danger btn-circle btn-xl" data-id={dv.id}><i className="fa fa-trash-o" data-idloaiquangcao={dv.id}></i></button> : ''}
              {localStorage.getItem('userrole')==="1" ? <button onClick={this.handleChiTietLoaiQuangCao} className="icon-list-demo btn btn-info btn-circle btn-xl" data-idloaiquangcao={dv.id} data-toggle="modal" data-target="#exampleModal1" data-whatever="@mdo"><i className="fa fa-pencil" onClick={this.handleChiTietLoaiQuangCao} data-idloaiquangcao={dv.id}></i></button> : ''}  
                </td>
