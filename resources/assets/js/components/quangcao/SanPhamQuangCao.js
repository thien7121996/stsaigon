        ...
        <table className="table-bordered table-hover table color-table primary-table" >
          <thead>
            <tr>
              ...
              {localStorage.getItem('userrole')==="1" ? <button type="button" className="btn btn-block  btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"><i className="fa fa-plus"></i></button> : ''}
              </th>
            </tr>
          </thead>
          ...
          {danhsachsanphamquangcao.map(dv => ( 
            <tr id={"sanphamquangcaoitem"+dv.id} data-itemdv={dv.id}>
              ...
              {localStorage.getItem('userrole')==="1" ? <button data-idsanphamquangcao={dv.id} onClick={this.handleDeleteSanPhamQuangCao} className="icon-list-demo btn btn-danger btn-circle btn-xl" data-id={dv.id}><i className="fa fa-trash-o" data-idsanphamquangcao={dv.id}></i></button> : ''}
              {localStorage.getItem('userrole')==="1" ? <button onClick={this.handleChiTietSanPhamQuangCao} className="icon-list-demo btn btn-info btn-circle btn-xl" data-idsanphamquangcao={dv.id} data-toggle="modal" data-target="#exampleModal1" data-whatever="@mdo"><i className="fa fa-pencil" onClick={this.handleChiTietSanPhamQuangCao} data-idsanphamquangcao={dv.id}></i></button> : ''}  
                </td>
