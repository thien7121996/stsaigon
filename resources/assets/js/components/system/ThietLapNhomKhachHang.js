        ...
        <table className="table-bordered table-hover table color-table primary-table" >
          ...
          {nhomkhachhang.map(cd => ( 
            <tr id={"nhomkhachhangitem"+cd.id} data-itemngt={cd.id}>
              ...
              {localStorage.getItem('userrole')==="1" ? <button data-idnhomkhachhang={cd.id} onClick={this.handleDeleteNhomKhachHang} className="icon-list-demo btn btn-danger btn-circle btn-xl" data-id={cd.id}><i className="fa fa-trash-o" data-idnhomkhachhang={cd.id}></i></button> : ''}
              {localStorage.getItem('userrole')==="1" ?    <button onClick={this.handleChiTietNhomKhachHang} className="icon-list-demo btn btn-info btn-circle btn-xl" data-idnhomkhachhang={cd.id} data-toggle="modal" data-target="#exampleModal1" data-whatever="@mdo"><i className="fa fa-pencil" data-idnhomkhachhang={cd.id}></i></button>: ''}  
              </td> 
