        ...
        <table className="table-bordered table-hover table color-table primary-table" >
          ...
          {chandoan.map(cd => ( 
            <tr id={"chandoanitem"+cd.id} data-itemcd={cd.id}>
              ...
              {localStorage.getItem('userrole')==="1" ? <button data-idchandoan={cd.id} onClick={this.handleDeleteChanDoan} className="icon-list-demo btn btn-danger btn-circle btn-xl" data-id={cd.id}><i className="fa fa-trash-o" data-idchandoan={cd.id}></i></button> : ''}
              {localStorage.getItem('userrole')==="1"  ?<button onClick={this.handleChiTietChanDoan} className="icon-list-demo btn btn-info btn-circle btn-xl" data-idchandoan={cd.id} data-toggle="modal" data-target="#exampleModal1" data-whatever="@mdo"><i className="fa fa-pencil" data-idchandoan={cd.id}></i></button> : ''}
                </td>
