        ...
        <table className="table-bordered table-hover table color-table primary-table" >
          ...
          {tiensubenh.map(cd => ( 
            <tr id={"tiensubenhitem"+cd.id} data-itemngt={cd.id}>
              ...
              {localStorage.getItem('userrole')==="1" ?  <button data-idtiensubenh={cd.id} onClick={this.handleDeleteTienSuBenh} className="icon-list-demo btn btn-danger btn-circle btn-xl" data-id={cd.id}><i className="fa fa-trash-o" data-idtiensubenh={cd.id}></i></button> : ''}
              {localStorage.getItem('userrole')==="1" ? <button onClick={this.handleChiTietTienSuBenh} className="icon-list-demo btn btn-info btn-circle btn-xl" data-idtiensubenh={cd.id} data-toggle="modal" data-target="#exampleModal1" data-whatever="@mdo"><i className="fa fa-pencil" data-idtiensubenh={cd.id}></i></button> : ''}
