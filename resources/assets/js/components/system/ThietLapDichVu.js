        ...
        <table className="table-bordered table-hover table color-table primary-table" >
          ...
          {dichvusanpham.map(dv => ( 
            <tr id={"dichvuitem"+dv.id} data-itemdv={dv.id}>
              ...
              {localStorage.getItem('userrole')==="1" ?  <button data-iddichvu={dv.id} onClick={this.handleDeleteDichVu} className="icon-list-demo btn btn-danger btn-circle btn-xl" data-id={dv.ID}><i className="fa fa-trash-o" data-iddichvu={dv.id}></i></button> : ''}
              {localStorage.getItem('userrole')==="1" ?  <button onClick={this.handleChiTietDichVu} className="icon-list-demo btn btn-info btn-circle btn-xl" data-iddichvu={dv.id} data-toggle="modal" data-target="#exampleModal1" data-whatever="@mdo"><i className="fa fa-pencil" data-iddichvu={dv.id}></i></button> : ''}
                </td>
