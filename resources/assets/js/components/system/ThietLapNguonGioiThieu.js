        ...
        <table className="table-bordered table-hover table color-table primary-table" >
          ...
          {nguongioithieu.map(cd => ( 
            <tr id={"nguongioithieuitem"+cd.id} data-itemngt={cd.id}>
              ...
              {localStorage.getItem('userrole')==="1" ?  <button data-idnguongioithieu={cd.id} onClick={this.handleDeleteNguonGioiThieu} className="icon-list-demo btn btn-danger btn-circle btn-xl" data-id={cd.id}><i className="fa fa-trash-o" data-idnguongioithieu={cd.id}></i></button> : ''}
              {localStorage.getItem('userrole')==="1" ?  <button onClick={this.handleChiTietNguonGioiThieu} className="icon-list-demo btn btn-info btn-circle btn-xl" data-idnguongioithieu={cd.id} data-toggle="modal" data-target="#exampleModal1" data-whatever="@mdo"><i className="fa fa-pencil" data-idnguongioithieu={cd.id}></i></button> : ''}
