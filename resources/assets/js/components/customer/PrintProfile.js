  ...
  const benhlyds=this.props.benhlyds
      return (
        ...
        <div className="col-md-12">
          ...
          />
          <ComponentToPrint key={datakhachhang.ID} benhlyds={benhlyds} benhly={benhly} datakhachhang={datakhachhang} dichvudieutri={dichvudieutri} tiensubenh={tiensubenh} nguongioithieu={nguongioithieu} ref={el => (this.componentRef = el)} />
        </div>
      )
    }
  }
