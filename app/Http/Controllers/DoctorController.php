...
class DoctorController extends Controller
{
    ...
    public function capnhatbacsi(Request $request,$id)
    {
      ...
      if($request->get('anhdaidien')==="nonuser.jpg")
      {
          $imageName=$doctor->anhdaidien;
      }
      else
      {
        $path = 'uploads\doctor';
      ...
      $doctor->ten = $request->get('ten');
      $doctor->dienthoai = $request->get('dienthoai');
      $doctor->ngaysinh = $request->get('ngaysinh');
      $doctor->anhdaidien = $imageName;
      $doctor->email = $request->get('email');
      $doctor->mota = $request->get('mota');
      $doctor->gioitinh = $request->get('gioitinh');
      $doctor->save();
