...
class Khachhang extends Model
{
    ...
    protected $fillable = ['hoten', 'gioitinh', 'ngaysinh', 'diachi', 'dienthoai', 'tiensubenh', 'gioithieu', 'khuvuc', 'dichvudieutri', 'nguongioithieu', 'anhdaidien', 'truocmatbefore', 'hamtrenbefore', 'hamduoibefore', 'truocmatafter', 'hamtrenafter', 'hamduoiafter', 'danhgia', 'sosao', 'bacsidieutri', 'trangthai'];
    ...
    {
    return $query->orwhere('ID',$value)->orWhere("dienthoai",$value)->orWhere("hoten", 'LIKE',"%".$value."%")->orderBy('ID', 'desc');
    }
    ...
    return $query->where('created_at','LIKE',$datefm." %")->orderBy('ID', 'desc');
    }
